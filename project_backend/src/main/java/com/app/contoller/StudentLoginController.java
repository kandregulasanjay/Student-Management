...
public class StudentLoginController {
	...
	@PostMapping("/login")
	public String loginUser(@RequestBody Student user) throws Exception {
		String tempSid=user.getEmailid();
	...
	public ResponseEntity<?> login(@RequestBody Student student){
		...
		try {
			Student userByUserAndPassword = studentService.authenticateUser(student.getEmailid(), student.getPassword());
			if (userByUserAndPassword!=null) {
				map.put("sid",userByUserAndPassword.getEmailid().toString());
