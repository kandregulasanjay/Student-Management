...
import com.app.Repository.AttandanceRepository;
...
@Service
@Transactional
public class AttandanceServiesImpl implements AttandanceServies{
	...
	@Override
	public Object findAttandanceByDate(LocalDate date) {
